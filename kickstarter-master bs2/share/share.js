$(function() {
    ...
    $('.facebook').on('click', function() {
        var w = 580, h = 300,
            ...
            if ((screen.width < 480) || (screen.height < 480)) {
                window.open ('http://www.facebook.com', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
            } else {
    ...
    $('.twitter').on('click', function() {
        var loc = encodeURIComponent('http://www.facebook.com'),
    ...
    $('.play').on('click', function() {
        window.location.href = "mailto:phatnhat@hotmail.com";
    });
